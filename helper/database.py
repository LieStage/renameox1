...
DB_NAME = os.environ.get("DB_NAME", "forrename")
DB_URL = os.environ.get("DB_URL", "mongodb+srv://fourg:rename@cluster0.4lhnmiy.mongodb.net/?retryWrites=true&w=majority")
