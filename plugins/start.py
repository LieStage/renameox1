...
CHANNEL = os.environ.get('CHANNEL', "-1001678093514")
...
bot_username = os.environ.get("BOT_USERNAME","Rename2_TrumBots_bot")
...
botid = token.split(':')[0]
FLOOD = 500
LAZY_PIC = os.environ.get("LAZY_PIC", "https://te.legra.ph/file/390208792e429dab23ab3.jpg")
	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://t.me/movie_time_botonly")],
                                      [InlineKeyboardButton("🦋 Subscribe us 🦋", url="https://youtube.com/c/AVENGERSGAMINGVARUN144")],
                                      [InlineKeyboardButton("Support Group", url='https://t.me/TRUMBOTCHAT'),
                                      InlineKeyboardButton("Movie Channel", url='https://t.me/+yw5hkKReqWoxMjY1')],
                                      [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://t.me/fligher')]
                                      ]))
        return
    if id:
        if old == True:
...
async def send_doc(client, message):
    ...
    if update_channel:
        try:
            ...
            await client.send_message(log_channel,f"🦋 #NewUser for 4gb 🦋,\n\n**ID** : `{user_id}`\n**Name**: {message.from_user.first_name} {message.from_user.last_name}\n**User-Plan** : {user}\n\n ",
